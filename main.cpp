...
void init_sistemaSolar(){
    ...
    planetario->add_planeta("assets/scripts/Mercurio.txt");
    planetario->add_planeta("assets/scripts/Venus.txt");
    planetario->add_planeta("assets/scripts/Terra.txt");
    planetario->add_planeta("assets/scripts/Marte.txt");
    planetario->add_planeta("assets/scripts/Jupiter.txt");
    planetario->add_planeta("assets/scripts/Saturno.txt");
    planetario->add_planeta("assets/scripts/Uranus.txt");
    planetario->add_planeta("assets/scripts/Netuno.txt");
    planetario->add_planeta("assets/scripts/Plutao.txt");

    //ao adicionar os planetas automaticamente será adicionado as luas deles
